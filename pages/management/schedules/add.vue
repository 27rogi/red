...
export default {
  ...
  methods: {
    ...
    sendData() {
      this.isLoading = true;
      this.$axios.$post(`${process.env.baseUrl}/v1/diary/schedules`, this.schedule).then((res) => {
...
.add {
  ...
  .schedule-edit {
    ...
    .schedule-edit__content {
      @apply flex flex-row flex-wrap my-4 text-gray-100/90 gap-4 justify-center;
      .schedule-edit__subject {
        @apply flex flex-col bg-background-100/30 p-4 w-3/12 gap-4;
